...
export const api = {
  ...
  links: params => http.get('/api/quick-links', { params: contextParams(params) }), link: data => http.post('/api/quick-links', data), updateLink: (id, data) => http.put(`/api/quick-links/${id}`, data), deleteLink: id => http.delete(`/api/quick-links/${id}`),
