...
export const api = {
  ...
  projects: params => http.get('/api/projects', { params }), project: id => http.get(`/api/projects/${id}`), createProject: data => http.post('/api/projects', data), updateProject: (id, data) => http.put(`/api/projects/${id}`, data), archiveProject: id => http.delete(`/api/projects/${id}`), projectDashboard: id => http.get(`/api/projects/${id}/dashboard`),
  ...
  memos: params => http.get('/api/memos', { params: typeof params === 'string' ? (params ? { keyword: params } : {}) : params }), memo: data => http.post('/api/memos', data), updateMemo: (id, data) => http.put(`/api/memos/${id}`, data), deleteMemo: id => http.delete(`/api/memos/${id}`),
